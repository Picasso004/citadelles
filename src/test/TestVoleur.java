...
public class TestVoleur {
    ...
    public void test2() {
        ...
        // tests:
        Test.test(roi.getVole(),"le roi est bien vole");
        Test.test(roi.getJoueur().nbPieces()==0, "le tresor du roi est vide");
        Test.test(voleur.getJoueur().nbPieces()==2, "le tresor du voleur contient deux pieces");
    }
