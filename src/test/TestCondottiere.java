...
public class TestCondottiere {
    ...
    public void test2() {
        ...
        q = new Quartier("Echoppe",Quartier.TYPE_QUARTIERS[3],2); pioche.ajouter(q);
        q = new Quartier("basilique",Quartier.TYPE_QUARTIERS[4],4,"A la fin de la partie, ...");
        pioche.ajouter(q);
        q = new Quartier("cathedrale",Quartier.TYPE_QUARTIERS[0],5); pioche.ajouter(q);
        ...
        if (mainAssassin != null) {
            for (int i = 0; i < mainAssassin.length; i++) {
                if (mainAssassin[i] != null) {
        ...
        if (mainCondottiere != null) {
            for (int i = 0; i < mainCondottiere.length; i++) {
                if (mainCondottiere[i] != null) {
        ...
        //mainAssassin
        System.out.print("Main de l'assassin (" + assassin.getJoueur().getNom() + "): ");
        mainAssassin = assassin.getJoueur().getCite();
        if (mainAssassin != null) {
            for (int i = 0; i < mainAssassin.length; i++) {
                if (mainAssassin[i] != null) {
                    System.out.print(mainAssassin[i].getNom() + ", ");
        ...
        mainCondottiere = condottiere.getJoueur().getCite();
        if (mainCondottiere != null) {
            for (int i = 0; i < mainCondottiere.length; i++) {
                if (mainCondottiere[i] != null) {
                    System.out.print(mainCondottiere[i].getNom() + ", ");
    ...
    public void test3() {
        ...
        Test.test(condottiere.getJoueur().nbPieces() == 3,
                "test du nombre de pieces d'or apres perception de ressources specifiques avec 1 quartier militaire");
    }
}
